...
public class ArpeggiatorTest {
	...
	public void testDownUp() {
		{
			...
			List<Pitch> actual = a.listArpeggio(Arpeggio.MAJOR, C1, 1);
			List<Pitch> expected = Arrays.asList(new Pitch[] { G1, E1, C1, E1, });
			assertEquals(expected, actual);
		}
		{
			Arpeggiator a = Arpeggiator.DOWN_UP;
			List<Pitch> actual = a.listArpeggio(Arpeggio.MAJOR, C1, 2);
	...
	public void testUpDown() {
		{
			...
			List<Pitch> actual = a.listArpeggio(Arpeggio.MAJOR, Pitch.C1, 1);
			List<Pitch> expected = Arrays.asList(new Pitch[] { C1, E1, G1, E1, });
			assertEquals(expected, actual);
		}
		{
			Arpeggiator a = Arpeggiator.UP_DOWN;
			List<Pitch> actual = a.listArpeggio(Arpeggio.MAJOR, Pitch.C1, 2);
	...
	public void testUp() {
		...
		{
			Arpeggiator a = Arpeggiator.UP;
			List<Pitch> actual = a.listArpeggio(Arpeggio.MAJOR, Pitch.C1, 3);
